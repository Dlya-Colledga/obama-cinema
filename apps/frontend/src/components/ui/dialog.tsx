...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-lg p-1 text-muted-foreground transition-opacity hover:text-foreground hover:bg-white/5 focus:outline-none focus:ring-2 focus:ring-primary/40 disabled:pointer-events-none">
        <X className="size-5" />
...
const DialogHeader = ({
  ...
  <div
    className={cn(
      'flex flex-col space-y-1.5 text-left pb-2 border-b border-white/5',
      className
    )}
    {...props}
  />
